...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   load_components_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: helarras <helarras@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/25 22:12:26 by helarras          #+#    #+#             */
/*   Updated: 2024/06/04 14:45:22 by helarras         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_object	*load_exit(mlx_t *mlx)
{
	...
	exit->sprites[0] = load_img_texture(mlx, "bonus/textures/exit_closed.png");
	exit->sprites[1] = load_img_texture(mlx, "bonus/textures/exit_opened.png");
	exit->sprites[2] = 0;
...
t_object	*load_coin(mlx_t *mlx)
{
	...
	if (!coin)
		return (NULL);
	coin->sprites = malloc(5 * sizeof(mlx_image_t));
	if (!coin->sprites)
	{
		free(coin);
		return (NULL);
	}
	coin->sprites[0] = load_img_texture(mlx, "bonus/textures/coin/coin_0.png");
	coin->sprites[1] = load_img_texture(mlx, "bonus/textures/coin/coin_1.png");
	coin->sprites[2] = load_img_texture(mlx, "bonus/textures/coin/coin_2.png");
	coin->sprites[3] = load_img_texture(mlx, "bonus/textures/coin/coin_3.png");
	coin->sprites[4] = 0;
...
t_object	*load_brick(mlx_t *mlx)
{
	...
	if (!brick->sprites)
		return (NULL);
	brick->sprites[0] = load_img_texture(mlx, "bonus/textures/brick.png");
	brick->sprites[1] = 0;
...
t_object	*load_bg(mlx_t *mlx)
{
	...
	if (!bg->sprites)
		return (NULL);
	bg->sprites[0] = load_img_texture(mlx, "bonus/textures/bg_brick.png");
	bg->sprites[1] = 0;
	bg->current_frame = 0;
	bg->frame_delay = 0;
	bg->hidden = 0;
